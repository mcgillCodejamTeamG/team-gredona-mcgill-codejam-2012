...
public class Client {
	...
	public Client(){
		...
		//TODO remove and pass in as parameter
	...
	private class PriceFeed extends Thread{
	    ...
	    public void run(){
	    	...
	    	try {
	    		...
	    		TableData td = new TableData(actionThread.getJSON()); 
	    		
	    		System.out.println("Size: " + td.getEMATable().length); 
	    		for (int i = 0; i < 10; i++){
	    			String row[] = td.getEMATable()[i];
